...
const SignIn = () => {
  ...
  const handleTheSubmit = () => {
    ...
    if (!formstate.username || !formstate.email || !formstate.password) {
      ...
      !formstate.email.endsWith("@gmail.com") &&
      !formstate.email.endsWith("@yahoo.com") &&
      !formstate.email.endsWith("@logicalmindsit.com")
    ) {
      toast({
        title: "Please Enter a Gmail, Yahoo, or Logical Minds IT Address",
        position: "top",
        status: "warning",
        duration: 2000,
        isClosable: true,
